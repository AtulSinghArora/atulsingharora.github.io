...
\begin{tabular}{rl}
    ...
    \textsc{\color{gray} Address:}   & 166 N Allen Av., Pasadena, CA 91106, USA \\
    \textsc{\color{gray} Phone:}     & +1 626 318 0732,
    %\textsc{\color{gray} Mobile:}      
                        +1 626 515 4073\\
...
\begin{longtable}{rrp{11cm}}
  & ~~2023 &\textbf{Talk} (Scheduled). \emph{Quantum Depth in the Random Oracle Model}\\
  &         & Symposium on Theory of Computing (\textsc{STOC}). Orlando, Florida, USA. \\
  & ~~{\mg 2022} & {\mg \textbf{Poster}. \emph{Oracle separations of hybrid quantum-classical circuits}}\\
  &         &{\mg Quantum Information Processing (\textsc{QIP}). Caltech, USA}\\
  & ~~{\mg 2022} &{\mg \textbf{Poster}. \emph{Improving the security of device independent weak coin flipping protocols.}}\\
  &         &{\mg Quantum Information Processing (\textsc{QIP}). Caltech, USA}\\  
  ...
  & ~~{\mg 2019}  &{\mg \textbf{Participant}.} \\
  & ~~~~~~ &{\mg \textsc{QuantAlgo} Workshop. CWI, Amsterdam, Netherlands.}\\
  ...
  & ~~{\mg 2018} &{\mg \textbf{Poster}. \emph{Quantum Weak Coin Flipping with bias 1/10}.} \\
  & ~~~~~~ &{\mg Quantum Information Processing (\textsc{QIP}). TU Delft, Netherlands.} \\
  & ~~{\mg 2017} &{\mg \textbf{Participant}.} \\
  & ~~~~~~ &{\mg Theory of Quantum Computation, Communication and Cryptography (\textsc{TQC}). Paris, France.}
  \end{longtable}
...
\begin{tabular}{rrp{11cm}}
  & ~~2023 & \emph{Hartree Postdoctoral Fellowship}, University of Maryland. \\  
...
% \begin{tabular}{rp{11cm}}
 ...
 & ~~2015     & Awarded the \emph{DAAD WISE} fellowship for a summer internship by and in Germany.\\
