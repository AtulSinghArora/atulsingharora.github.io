...
\begin{tabular}{rl}
    ...
    \textsc{Internet:}     & \href{mailto:atul.singh.arora@gmail.com}{atul.singh.arora@gmail.com}, \href{https://atulsingharora.github.io}{atulsingharora.github.io}
\end{tabular}
...
\textsc{2011-14}  & Intern, {\footnotesize worked on yarn defect recognition using OpenCV at} \textsc{Indian Institute of Technology, Bombay} 
...
& CPI: \textbf{9.4} /10. \small Graduated with \emph{rank two.} \hyperlink{grades}{\hfill | \footnotesize Evaluation Details}\\&\\ 
...
\begin{tabular}{cp{9cm}c}
  ...
  Introduction to computers, Physics lab I, Chem lab I, Bio lab I &8.5/10 \\
